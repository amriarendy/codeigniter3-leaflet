...
<script>
    ...
    var locate1 = L.marker([-6.174745602970009, 106.8270924213689]).bindPopup("<span>Monument Nasional (Monas) Indonesia</span>").addTo(map).openPopup();
    var locate2 = L.marker([-6.169412279978709, 106.83112646390256]).bindPopup("<span>Masque Istiqlal</span>").addTo(map);
</script>
